...
class TaskThree : virtual public SceneBase {
public:
    using SceneBase::SceneBase; // inherit constructor

    TaskThree(WindowContext& context, PerspectiveCamera& camera, RenderSettings& settings);
...
#include "../../resources/shaders/terrainTex.frag"
    ...
    const char* m_multipleLightsVert =
#include "../../resources/shaders/basicTexLight-MultipleLights.vert"
;

    const char* m_multipleLightsFrag =
...
;
    ...
    ShaderComponent pieceShader;

    // SkyBox
    Cubemap* skyBox;
    const char *skyBoxVertSrc =
#include "../../resources/shaders/cubemap.vert"
;
    
    const char *skyBoxFragSrc =
